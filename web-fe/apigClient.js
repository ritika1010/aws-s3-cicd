...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://x7e7p521wg.execute-api.us-east-1.amazonaws.com/final';
    ...
    apigClient.bucketKeyPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-customLabels'], ['body']);
        
        var bucketKeyPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/{bucket}/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', ])),
        ...
        return apiGatewayClient.makeRequest(bucketKeyPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.bucketKeyOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var bucketKeyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/{bucket}/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(bucketKeyOptionsRequest, authType, additionalParams, config.apiKey);
    };
